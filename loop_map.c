...
int	valid_wall(char **map, t_pos pos)
{
	...
	if ((pos.y == 0 || map[pos.y - 1][pos.x] == VOID) && (pos.x == 0
			|| map[pos.y][pos.x - 1] == VOID) && (pos.y == ht || map[pos.y
			+ 1][pos.x] == VOID) && (pos.x == wh || map[pos.y][pos.x
			+ 1] == VOID) && map[pos.y - 1][pos.x - 1] == VOID && map[pos.y
		+ 1][pos.x + 1] == VOID && map[pos.y - 1][pos.x + 1] == VOID
