...
void			player_move_left(t_player *player, void *mlx_ptr,
					void *win_ptr);
void			player_move_down(t_player *player, void *mlx_ptr,
					void *win_ptr);
...
void			rotate_vector_clockwise(t_vector *fixed_point_vector,
					t_vector *vector);
void			rotate_vector_counter_clockwise(t_vector *fixed_point_vector,
					t_vector *vector);
